...
> = {
  ...
  photo: {
    label: '拍照任务',
    icon: '📷',
    iconImage: '/images/youjian-pin.jpg',
    accent: '#FF8C42',
    accentSoft: '#FFF7ED',
  },
  findObject: {
...
export const presetTasks: TaskContent[] = [
  {
    ...
    description: '到达柚见茶铺 1F 门店，开启你的探鲜之旅',
    promptHint: '',
  ...
  },
  {
    ...
    description: '拍下柚见茶铺橱窗里最吸引你的夏日新品',
